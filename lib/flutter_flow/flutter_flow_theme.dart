...
abstract class FlutterFlowTheme {
  ...
  late Color main;
  late Color second;
  late Color customWhite;
  late Color corrailOrange;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF406C66);
  ...
  late Color main = const Color(0xFFA8DADC);
  late Color second = const Color(0xFF457B9D);
  late Color customWhite = const Color(0xFFF1FAEE);
  late Color corrailOrange = const Color(0xFFE76F51);
  late Color customGreen = const Color(0xFF2A9D8F);
