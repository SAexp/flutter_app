...
class SupabaseAuthManager extends AuthManager with EmailSignInManager {
  ...
  Future deleteUser(BuildContext context) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('The authentification has encoutered a problem')),
      );
    }
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      final authUser = user == null ? null : ILiveHereSupabaseUser(user);
      ...
      final errorMsg = e.message.contains('User already registered') ?? false
          ? 'This email adress is already in use, take a look at your coordinator mails'
          : 'The authentification has encoutered a problem';
      ScaffoldMessenger.of(context).hideCurrentSnackBar();
      ScaffoldMessenger.of(context).showSnackBar(
