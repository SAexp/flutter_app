...
class EditEventWidget extends StatefulWidget {
  ...
  final EventUniversityRow? eventdata;
...
class _EditEventWidgetState extends State<EditEventWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.dateevent = widget.eventdata?.evDate;
      setState(() {});
    });

    _model.yourNameTextController ??=
        TextEditingController(text: widget.eventdata?.evName);
    _model.yourNameFocusNode ??= FocusNode();

    _model.cityTextController ??=
        TextEditingController(text: widget.eventdata?.evAddress);
    _model.cityFocusNode ??= FocusNode();

    _model.myBioTextController ??=
        TextEditingController(text: widget.eventdata?.evDescription);
                ...
                children: [
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          final datePickedDate = await showDatePicker(
                            context: context,
                            initialDate:
                                (widget.eventdata?.evDate ?? DateTime.now()),
                          ...
                          _model.dateevent = _model.datePicked;
                        },
                        text: 'Date',
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await EventUniversityTable().update(
                            data: {
                              'ev_name': _model.yourNameTextController.text,
                              'ev_address': _model.cityTextController.text,
                              'ev_date':
                                  supaSerialize<DateTime>(_model.dateevent),
                              'ev_description': _model.myBioTextController.text,
                            },
                            matchingRows: (rows) => rows.eq(
                              'ev_id',
                              widget.eventdata?.evId,
                            ),
                          );
                          context.safePop();
                        },
