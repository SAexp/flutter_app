...
class EventWidget extends StatefulWidget {
  ...
  final EventUniversityRow? idParameter;
          ...
          child: Align(
            ...
            child: Column(
              ...
              children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 4.0, 0.0, 0.0),
                                    child: Text(
                                      widget.idParameter!.evDate!.toString(),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 12.0),
                                    child: Text(
                                      widget.idParameter!.evDescription!,
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
                ...
                Opacity(
                  opacity: _model.participate ? 0.5 : 1.0,
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(16.0, 8.0, 16.0, 40.0),
                    child: Container(
                      width: 370.0,
                      height: 50.0,
                      decoration: BoxDecoration(
                      ...
                      alignment: const AlignmentDirectional(0.0, 0.0),
                      child: Text(
                        _model.participate ? 'I don\'t go' : 'I go !',
